...
public class ActivityOne extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTvResum e= (TextView) findViewById(R.id.resume);
	...
	public void onStart() {
		...
		mTvStart.setText(Integer.toString(mStart));
	}
	...
	public void onResume() {
        ...
        mResume = mResume + 1;
        // Update the user interface
        mTvResume.setText(Integer.toString(mResume));
	...
	public void onRestart() {
        ...
        mRestart = mRestart + 1;
        // Update the user interface
        mTvRestart.setText(Integer.toString(mRestart));
