...
public class CharacterListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<CharacterContent.Character>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, CharacterContent.Characters));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(CharacterContent.Characters.get(position).id);
	}
